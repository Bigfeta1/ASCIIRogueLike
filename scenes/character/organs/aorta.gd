...
var volume: float   = 688.3   # mL — steady-state value
...
const COMPLIANCE: float        = 1.59   # mL/mmHg
const UNSTRESSED_VOLUME: float = 550.0 # mL
const BASELINE_SYSTEMIC_RESISTANCE: float = 1.26 # mmHg·s/mL — resting value
var   systemic_resistance: float          = 1.26 # mmHg·s/mL — modulated by sympathetic tone
